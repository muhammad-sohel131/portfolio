      ...
      <div className="max-w-6xl w-full px-6 md:px-10 mx-auto py-20">
        <div className="flex flex-col lg:flex-row items-center justify-between w-full gap-12">
          ...
          <div className="flex-1 space-y-6 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full" style={{ backgroundColor: 'var(--color-secondary)', border: '1px solid var(--color-border)' }}>
            ...
            <div>
              <h1 className="font-mono text-2xl md:text-3xl mb-3" style={{ color: 'var(--color-primary)' }}>
                {displayText}
              ...
              <p className="text-xl mt-4 max-w-lg mx-auto lg:mx-0" style={{ color: 'var(--color-foreground)' }}>
            ...
            <div className="relative p-6 rounded-2xl shadow-xl" style={{ backgroundColor: 'var(--surface)', border: '1px solid var(--color-border)' }}>
              <div className="flex items-center gap-3 mb-4">
                <i className="fas fa-quote-left text-blue-600 text-2xl"></i>
                <span className="font-mono text-sm" style={{ color: 'var(--color-muted)' }}>mission statement</span>
              </div>
              <p className="italic leading-relaxed" style={{ color: 'var(--color-foreground)' }}>
              ...
              <div className="mt-4 flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs font-mono" style={{ color: 'var(--color-muted)' }}>Software Engineer</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 w-full max-w-md space-y-6">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl p-1">
                  <div className="relative rounded-xl overflow-hidden aspect-square" style={{ backgroundColor: 'var(--surface)' }}>
                  <Image
                    src="/meImage.png"
